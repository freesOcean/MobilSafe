...
import com.itheima.mobilesafe.activity.SettingActivity;
import com.itheima.mobilesafe.base.MyApplication;
import com.itheima.mobilesafe.ui.LockPatternView.Cell;
import com.itheima.mobilesafe.ui.LockPatternView.DisplayMode;
...
public class CreateGesturePasswordActivity extends Activity implements
	...
	private Stage mUiStage = Stage.ReadyToStart;
	...
	protected enum Stage {
		...
		HelpScreen(R.string.lockpattern_settings_help_how_to_record,
				...
				false), 
	    ReadyToStart(R.string.lockpattern_recording_intro_header,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mLockPatternView.setTactileFeedbackEnabled(false);// 设置触屏时是否产生振动
	...
	protected LockPatternView.OnPatternListener mChooseNewLockPatternListener = new LockPatternView.OnPatternListener() {
		...
		public void onPatternDetected(List<LockPatternView.Cell> pattern) {
			...
			} else if (mUiStage == Stage.ReadyToStart
	...
	public void onClick(View v) {
		...
		case R.id.reset_btn:
			if (mUiStage.leftMode == LeftButtonMode.Retry) {
				mChosenPattern = null;
				mLockPatternView.clearPattern();
				updateStage(Stage.ReadyToStart);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if (keyCode == KeyEvent.KEYCODE_MENU && mUiStage == Stage.ReadyToStart) {
			updateStage(Stage.HelpScreen);
			return true;
		}
		return false;
