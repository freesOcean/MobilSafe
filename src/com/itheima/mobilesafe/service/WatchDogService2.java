...
public class WatchDogService2 extends Service {
	...
	public void onCreate() {
		...
		registerReceiver(dataChangeReceiver, new IntentFilter(WatchDogService2.ACTION_APPLOCK_DATACHANG));
...
//			tempStopPackName = intent.getStringExtra(KEY_PACKNAME);
	...
	public void onDestroy() {
		Log.i("WatchDog", "dog2我挂了");
		// 启动另一个看门狗
		Intent i = new Intent(getApplicationContext(), WatchDogService.class);
		startService(i);
		flag = false;
